    ...
    return (
        <CustomizedCard title="Portfolio">
            ...
            {tokenList.map((token: TokenState) => {
                if (token.name === "Ether") { // need to align wallet symbol with symbol in sipmath AND figure out search for correct library
                ...
                return (
                    <TokenRow
                        ...
                        currentUsd={(token.balance * 3324.00)}
    ...
    return (
        <div className="token-row">
            ...
            <div style={{ display: "flex", width: "10%", height: "100%" }}>
                <Sparklines style={{ fill: "none" }} data={tempData1} limit={50}  >
                    <SparklinesBars />
                </Sparklines>
            </div>
        </div >

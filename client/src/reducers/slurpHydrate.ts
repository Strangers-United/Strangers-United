...
const initialState = {
    slurpList: slurpList
        .map((token: ISlurp) => {
            return {
                location: "just testing",
                sips: ["sip 1 init", "sip 2 init"],
